...
struct FixedTokenChunker: RAGChunker {
    let chunkSize: Int
    let overlap: Int
    ...
    init(chunkSize: Int = 500, overlap: Int = 50, maxCharacters: Int = 1_200) {
...
struct StructureChunker: RAGChunker {
    private let fallback = FixedTokenChunker(chunkSize: 500, overlap: 50)
